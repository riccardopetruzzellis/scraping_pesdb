...
CHUNK_RATE_LIMIT_BACKOFF_SECONDS = float(os.getenv("PESDB_CHUNK_RATE_LIMIT_BACKOFF_SECONDS", "180"))
CHUNK_RATE_LIMIT_ATTEMPTS = max(1, int(os.getenv("PESDB_CHUNK_RATE_LIMIT_ATTEMPTS", "2")))
